...
type ShiftSplatnetBossCountsBoss struct {
	Boss  ShiftSplatnetBossCountsBossDouble `json:"boss"`
	Count int                               `json:"count"`
}

type ShiftSplatnetBossCountsBossDouble struct {
	Key  enums.ShiftSplatnetBossCountsBossDoubleKeyEnum `json:"key"`
	Name string                                         `json:"name"`
}
