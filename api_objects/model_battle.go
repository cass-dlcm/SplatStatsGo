...
type Battle struct {
	...
	BattleNumber            int64                   `json:"battle_number"`
	...
	Stage                   enums.BattleStage       `json:"stage"`
...
type BattleSplatnet struct {
	...
	Stage               BattleSplatnetTriple         `json:"stage"`
...
type BattleSplatnetPlayerResultPlayerClothingBrand struct {
	...
	Name          string               `json:"name"`
	FrequentSkill BattleSplatnetTriple `json:"frequent_skill"`
}
...
type BattleSplatnetPlayerResultPlayerSkills struct {
	Main BattleSplatnetTriple   `json:"main,omitempty"`
	Subs []BattleSplatnetTriple `json:"subs,omitempty"`
}

type BattleSplatnetTriple struct {
	Id    string `json:"id"`
	Image string `json:"image"`
	Name  string `json:"name"`
}
