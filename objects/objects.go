...
// A ShiftSplatnet is the Salmon Run shift as downloaded from Splatnet 2.
...
// A BattleSplatnet is the PvP battle as downloaded from Splatnet 2.
...
// A Shift is a flattened ShiftSplatnet.
type Shift struct {
	DangerRate              float64        `json:"danger_rate"`
...
// A Battle is a flattened BattleSplatnet.
type Battle struct {
	...
	SplatnetJSON            *BattleSplatnet `json:"splatnet_json"`
...
// BattleList is a list of up to 50 partial BattleSplatnets, with additional metadata.
...
// ShiftList is a list of up to 50 partial ShiftSplatnets, with additional metadata.
